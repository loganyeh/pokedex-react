    ...
    return(
        <>
            <div className={`border border-gray-200 ${SplashPageColor(data?.type_one)} text-white h-auto w-65 my-6 rounded-xl shadow-md`}>
                ...
                {/* NAME and NUMBER */}
                <div className="h-8 w-full p-4 text-2xl font-semibold text-shadow-lg">#197</div>
                <div className="h-8 w-full p-4 text-2xl font-semibold text-shadow-lg">Umbreon</div>

                {/* H/W REGION INFO */}
                <div className="h-23 w-full flex">
                    {/* region */}
                    <div className="h-full w-1/3 flex justify-center items-center text-sm rotate-270 text-shadow-lg">Region: Kanto</div>
                    {/* height and weight */}
                    <div className="h-full w-2/3">
                        <div className="h-1/2 w-full text-shadow-lg"></div>
                        <div className="h-1/2 w-full text-sm text-shadow-lg">
